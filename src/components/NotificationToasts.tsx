...
export function NotificationToasts({
  ...
  return (
    <div className="fixed bottom-[calc(4.75rem+env(safe-area-inset-bottom,0px))] lg:bottom-4 right-4 z-50 flex flex-col gap-2.5 max-w-sm w-[calc(100vw-32px)] sm:w-full pointer-events-none">
      <AnimatePresence>
        {toasts.map((toast) => {
